...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = getenv("SQLALCHEMY_DATABASE_URI") or "sqlite:///" + path.join(basedir, "palye.db")
    SQLALCHEMY_TRACK_MODIFICATIONS = False

    TITLE = getenv("TITLE", "Palye")
    BRIEF = getenv("BRIEF", "Palye Danışmanlık")
